...
def file_one():
    ...
    myLabel1 = Label(first_frame,text="TEXT ENCRYPTION",bg="light goldenrod",fg="black")
    myLabel2 = Label(first_frame,text="ADVANCED ENCRYPTION STANDARD",bg="light goldenrod",fg="black")
    ...
    orLabel = Label(first_frame,text="------------------OR---------------------",font="italic",bg="light goldenrod",fg="black")
    orLabel.grid(row=7,column=1)
...
def file_two():
    ...
    myLabel1 = Label(sec_frame,text="TEXT DECRYPTION",bg="light goldenrod",fg="black")
    myLabel2 = Label(sec_frame,text="ADVANCED ENCRYPTION STANDARD",bg="light goldenrod",fg="black")
    myLabel1.grid(row=0,column=1)
    myLabel2.grid(row=1,column=1)
    
    instLabel = Label(sec_frame,text="Enter the filename situated in '/AES-Encrption-Using-Python/'  ",font="bold",bg="light goldenrod")
...
def file_three():
    ...
    myLabel1 = Label(third_frame,text="VERSION 1.1",font="bold",bg="coral")
...
e1 = Entry(first_frame,show='*',width=70,borderwidth=6)
e2 = Entry(first_frame,width=70,borderwidth=6)
e3 = Entry(first_frame,width=70,borderwidth=6)
ex = Entry(first_frame,show='*',width=70,borderwidth=6)
